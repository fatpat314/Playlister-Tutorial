...
class PlaylistsTests(TestCase):
    ...
    #def test_show_playlist(self,mock_find):
        ...
        #result = self.client.get(f'{/playlists/playlist_id}/edit')
        #self.assertEqual(result.status, '200 OK')
    ...
    @mock.patch('pymongo.collection.Collenction.insert_one')
    ...
    def test_submit_playlist(self,mock_insert):
        ...
        #after submitting, should redirect to that playlists home
        self.assertEqual(result.status, '302 FOUND')
        mock_insert.assert_called_with(sample_playlist)
